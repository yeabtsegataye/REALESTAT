...
// Check if session variables for users are set
if(isset($_SESSION['US_FNAME'])) {
    echo "User First Name is set.".$_SESSION['US_FNAME'];
} else {
    echo "User First Name is not set.";
}

if(isset($_SESSION['US_LNAME'])) {
    echo "User Last Name is set.".$_SESSION['US_LNAME'];
} else {
    echo "User Last Name is not set.";
}

if(isset($_SESSION['US_EMAIL'])) {
    echo "User Email is set.".$_SESSION['US_EMAIL'];
} else {
    echo "User Email is not set.";
}

if(isset($_SESSION['US_ID'])) {
    echo "User ID is set.".$_SESSION['US_ID'];
} else {
                                        ...
                                        <div class="form-group">
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="adminRadio" name="loginAs"
                                                    class="custom-control-input" value="admins">
