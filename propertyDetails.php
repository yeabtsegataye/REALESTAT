            ...
            <div class="row mb-5 mt-2">
              ...
              <div class="col-md-6">
                <ul class="list-unstyled property-specs-wrap mb-3 mb-lg-0 float-lg-right">
                  ...
                  <li class="list-inline-item d-line-block mr-3">
                    <span class="property-specs sqft">sevice</span><br>
                    <span class="property-specs-number number"><strong>
                        <?php echo $propertyData['RN_SALON']; ?>
                      </strong></span>
                  </li>
                  <li class="list-inline-item d-line-block mr-3">
                    <span class="property-specs sqft"> salon</span><br>
                    <span class="property-specs-number number"><strong>
                        <?php echo $propertyData['RN_SERVICE ']; ?>
                      </strong></span>
                  </li>
                </ul>
              </div>
